...
export const DOMAIN = "https://mgjinx.com";
...
export interface SearchMetadata extends JSONObject {
  ...
  genreMode?: string[];
  // Set by the Top Manga chips so the search runs against /top/<range>
  // instead of the regular filter endpoint.
  topRange?: string;
}

// Mirrors the site's own "Sort by" dropdown.
